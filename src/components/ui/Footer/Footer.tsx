...
const Footer: FC = () => {
  ...
  const usefulLinks = [
    { link: '/', text: 'Payment and Shipping Methods' },
  ];
      ...
      <div className={`${common._container} ${styles.footer__container}`}>
        ...
        <section className={styles.footer__rights}>
          <div className={styles.footer__info}>
            All materials presented on the site are for informational purposes only and
            do not constitute a public offer as defined by Article 641 of the Civil Code
            of Ukraine. When copying materials, a hyperlink to www.zlatmax.ua is
            mandatory!
          </div>
